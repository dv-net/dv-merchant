...
type Querier interface {
	...
	CalculateTotalAmountsByInvoice(ctx context.Context, invoiceID uuid.NullUUID) (*CalculateTotalAmountsByInvoiceRow, error)
	...
	GetByInvoiceID(ctx context.Context, invoiceID uuid.NullUUID) ([]*models.Transaction, error)
