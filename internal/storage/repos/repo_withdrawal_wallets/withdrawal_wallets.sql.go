...
SELECT u.id, u.email, u.email_verified_at, u.password, u.remember_token, u.processing_owner_id, u.location, u.language, u.rate_source, u.created_at, u.updated_at, u.deleted_at, u.banned, u.exchange_slug, u.rate_scale, u.dvnet_token,
       ...
       curr.id, curr.code, curr.name, curr.precision, curr.is_fiat, curr.blockchain, curr.contract_address, curr.withdrawal_min_balance, curr.has_balance, curr.status, curr.sort_order, curr.min_confirmation, curr.created_at, curr.updated_at, curr.is_stablecoin, curr.currency_label, curr.token_label, curr.is_native, curr.is_new_store_default, curr.order_idx,
